...
<div class="wrapper" id="wrapper">
              ...
              <div class="container">
                ...
                <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="menuItem"><a href="#aboutme">Sobre mi</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class=" col-xs-12 col-sm-12 col-md-7 col-lg-7">
          <h1 class="nombre-titulo">Alejandro Zorita</h1>
          <h2 class="subHeading">Laravel Back-End Developer</h2>
          <p>Desde pequeñito me ha apasionado el mundo de los ordenadores. De siempre recuerdo empezar reparando y
            configurando los ordenadores de amigos y familiares.</p>
          <p>Tras unos años trabajando, decidi que era hora de probar suerte en el mundo de la programación ya que
            siempre me había parecido mágico... </p>
          <p>Tras titularme como técnico superior, empece a trabajar y a ver el gran potencial y apasionante mundo de la
            programación web.</p>
          <p>Actualmente me encuentro trabajando como desarrollador Laravel Back-End (he de decir que el backend me
            resulta más apasionante) y estudiando el Grado en Ingeniería Informática en la univerisdad Complutense de
            Madrid.</p>
        ...
        <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 col-md-offset-1 col-lg-offset-1 proPic">
          <img
            src="{{ asset('images/alejandro-zorita.jpg') }}" alt="alejandro zorita Laravel Back-End Developer madrid españa"
            title="alejandro zorita Laravel Back-End Developer madrid españa" class="img-circle"
  ...
  <section class="technical" id="technical">
    <div class="container">
      <div class="heading">
        <span class="titulos-pagina">Technical Skills</span>
        <!--<p>I can say i’m quite good at</p>-->
      </div>
      <div class="row">
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"><span class="chart skilBg" data-percent="85"> <span
                class="percent"></span> </span>
            <h4>Laravel</h4>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"><span class="chart skilBg" data-percent="60"> <span
                class="percent"></span> </span>
            <h4>TDD</h4>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"><span class="chart skilBg" data-percent="70"> <span
                class="percent"></span> </span>
            <h4>DevOPS</h4>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"><span class="chart skilBg" data-percent="65"> <span
                class="percent"></span> </span>
            <h4>VUEjs</h4>
          </div>
        </div>
        ...
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"><span class="chart skilBg" data-percent="75"> <span
                class="percent"></span> </span>
            <h4>MySQL</h4>
          </div>
        </div>
  ...
  <section class="exprience" id="exprience">
    <div class="container">
      <div class="heading">
        <span class="titulos-pagina">Experiencia Laboral</span>
      </div>

      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Marzo, 2016<br>
            Marzo 2016
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          ...
          <div class="exCon">
            <h4>IT Manager - Laravel Back-End Developer</h4>
            <h5>Medssocial</h5>
            <p>Sin dejar de lado la programación, me encargo dirección de equipo de IT y gestión de proyectos.</p>
            <p></p>
            <p></p>
          </div>
        </div>
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Mayo, 2011<br>
            Marzo, 2016
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          ...
          <div class="exCon">
            ...
            <h5>IHC Salud</h5>
            <p>Mi primer gran reto. Proyectos ambiciosos, desarrollos novedosos, nuevas tecnologías y propuestas para
              llegar muy alto en el mundo del e-health</p>
            <p>Gracias a un reto diario y constante, sacamos a delante grandes proyectos para clientes importantes, sin
              duda, una grandísima experiencia!</p>
            <p>Actualmente descubriendo y apasionandome cada día más con Laravel - VUEjs</p>
          </div>
        </div>
      </div>
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Abril, 2013<br>
            Junio, 2013
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          ...
          <div class="exCon">
            ...
            <h5>Asociación de Mutuas de Accidentes de Trabajo ‘AMAT’</h5>
            <p>Una gran toma de contacto en el mundo del desarrollo dentro de una empresa. Muy agredecido de la
              oportunidad que me dieron y del trato.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Marzo, 2008<br>
            Marzo, 2012
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          ...
          <div class="exCon">
            <h4>Freelance</h4>
            <h5>AZH Informática</h5>
            <p>Tras adquirir experiencia en el sector, me decidí a aventurarme en el mundo del freelance. Esta gran
              experiencia me enseño mucho sobre la autogestión y como es el mundo empresarial desde una perspectiva
              mucho más cercana!</p>
          </div>
        </div>
      </div>

      <div class="row workDetails" style="margin-bottom:50px;">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Octubre, 2007<br>
            Febrero 2008
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Técnico de Sistemas</h4>
            <h5>Yodeyma Perfumes S.L.</h5>
          </div>
        </div>
      </div>
      ...
      <div class="row workDetails" style="margin-bottom:50px;">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Abril, 2007<br>
            Octubre, 2007
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">Marzo, 2007<br>
            Abril, 2007
          </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Especialista Informático</h4>
            <h5>Compusoft S.A. ‘Telefónica Movistar’</h5>
          </div>
        </div>
      </div>
  ...
  <section class="education" id="education">
    <div class="container">
      <div class="heading">
        <span class="titulos-pagina">Formación</span>
      </div>
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">2013, Actualidad</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
      ...
      <div class="row workDetails">
        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
          <div class="workYear">2002, 2004</div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
          <div class="arrowpart"></div>
          <div class="exCon">
            <h4>Tecnico en Explotación de Sistemas Informáticos </h4>
            <h5>IES Vallecas I</h5>
          </div>
        </div>
      </div>
    </div>
